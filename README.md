...
| ![Francisco](imgs/FotoLiam.png) | **Francisco Uribe Linares** | u20211b686 | Ingeniería de Software | Soy estudiante de séptimo ciclo de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas. Cuento con conocimientos en C++ y Python, orientados al desarrollo de soluciones y resolución de problemas. Me caracterizo por ser perseverante, responsable, adaptable y comprometido con el trabajo en equipo. |
